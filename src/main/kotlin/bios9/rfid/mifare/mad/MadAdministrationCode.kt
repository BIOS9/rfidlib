...
enum class MadAdministrationCode(val applicationCode: UByte?, val description: String) {
  ...
  ADDITIONAL_DIRECTORY_INFO(
      0x03u, "Sector contains additional directory info (useful only for future cards)"),
  ...
  companion object {
    private val map =
        MadAdministrationCode.entries.associateBy(MadAdministrationCode::applicationCode)
